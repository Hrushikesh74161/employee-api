...
class EmployeeTests(APITestCase):
    def setUp(self) -> None:
        ...
        Employee.objects.create(
            name="Employee", age=32, department="Sales", salary=40000, gender="M"
        )
        Employee.objects.create(
            name="AnotherEmployee", age=25, department="Tech", salary=45000, gender="F"
        )

        # user for tests
        User.objects.create_user(
            email="testuser@email.com", username="testuser", password="testuser@1234"
        )
    ...
    def test_create_employee_with_wrong_age(self):
        data = {
            "name": "employee",
            "age": "65",
            "gender": "F",
